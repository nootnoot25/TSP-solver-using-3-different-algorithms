...
public class GA {
    ...
    private static final int POPULATION_SIZE = 100; //population of solutions generated by 2-opt
    private static final int NUM_GENERATIONS = 1000; //number of generations to create
    private static final double MUTATION_RATE = 0.00000001; //population mutation rate

    private static final int NUM_ELITES = 10; //elite list of parents to keep
